...
<tr>
	...
	$view=mysqli_query($link,"SELECT distinct nama_guru, guru.id_guru FROM data_guru guru, tbl_kuesioner kuesioner WHERE kuesioner.id_guru=guru.id_guru order by guru.nama_guru asc");			
	$i = 0;
	...
	<tr>
		...
		<td><a href="?page=kuesioner_review_guru_all&id_guru=<?php echo $id_guru;?>" title="Klik untuk mengisi kuesioner"><b><font color="#0066FF">Hasil Kuesioner</font></b></a></td>
	</tr>
	<?php
	}
	?>
