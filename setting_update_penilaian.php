...
-->
	...
	<tr>
		...
		<div id="content-table-inner">
            ...
            <form action="?page=setting_update_penilaian" method="post">
                ...
                <!--  end step-holder -->
                  ...
                  <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                    ...
                    <tr>
					 ...
					 <tr>
                      <th valign="top">Kunci</th>
                      <td><select name="kunci"  class="styledselect_form_1">
                    ...
                    <tr>
                      <th>&nbsp;</th>
                      <td valign="top"><input type="submit" name="submit" value="Filter Data" class="form-submit" onClick="return confirm('Apakah Anda yakin akan mengijinkan guru untuk mengubah nilai? Pastikan Anda memilih guru, kelas, dan matapelajaran yang akan di ubah')" />
                      </td>
                      <td></td>
                    </tr>
                  </table>
			...
			<p><em>* Jika Nilai ingin diubah, ganti  <strong>kunci</strong> menjadi </em><span class="style1">No</span>
			  <!--  start product-table ..................................................................................... -->
              </p>
			<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
                  	<th class="table-header-options line-left"><a href="">Nomor</a></th>
					...
					<th class="table-header-options line-left"><a href="">Kelas</a></th>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">Siswa</a></th>
				  	...
				  	<th class="table-header-options line-left"><a href="">Tugas</a></th>
					<th class="table-header-options line-left"><a href="">UTS</a></th>
					<th class="table-header-options line-left"><a href="">UAS</a></th>
					<th class="table-header-options line-left"><a href=""><font color="#00FF00">KUNCI</font></a></th>
				</tr>
				...
				if(isset($_POST['submit'])){
					...
					if($id_guru!=="0" && $id_siswa!=="0" && $id_matapelajaran!=="0" && $kunci!=="0"){
						//update nilai
						$view_nilai=mysqli_query($link,"SELECT siswa.id_siswa, siswa.nama_siswa, siswa.nis, guru.nama_guru, guru.nip, ruangan.id_kelas, matapelajaran.nama_matapelajaran, nilai.nilai_tugas, nilai.nilai_uts, nilai.nilai_uas, nilai.kunci FROM tbl_nilai nilai, data_siswa siswa, setup_matapelajaran matapelajaran, tbl_ruangan ruangan, data_guru guru WHERE nilai.id_siswa=siswa.id_siswa and nilai.id_matapelajaran=matapelajaran.id_matapelajaran and nilai.id_guru=guru.id_guru and ruangan.id_siswa=siswa.id_siswa and nilai.id_periode='$id_periode' $filter_guru $filter_matapelajaran $filter_kelas order by guru.nama_guru asc");
						while($rows=mysqli_fetch_array($view_nilai)){
							$id_siswa=$rows['id_siswa'];
							$update=mysqli_query($link,"update tbl_nilai set `kunci`='$kunci' where id_siswa='$id_siswa' and id_matapelajaran='$id_matapelajaran' and id_guru='$id_guru'");
						}
					}
				...
				$view=mysqli_query($link,"SELECT siswa.id_siswa, siswa.nama_siswa, siswa.nis, guru.nama_guru, guru.nip, ruangan.id_kelas, matapelajaran.nama_matapelajaran, nilai.nilai_tugas, nilai.nilai_uts, nilai.nilai_uas, nilai.kunci FROM tbl_nilai nilai, data_siswa siswa, setup_matapelajaran matapelajaran, tbl_ruangan ruangan, data_guru guru WHERE nilai.id_siswa=siswa.id_siswa and nilai.id_matapelajaran=matapelajaran.id_matapelajaran and nilai.id_guru=guru.id_guru and ruangan.id_siswa=siswa.id_siswa and nilai.id_periode='$id_periode' $filter_guru $filter_matapelajaran $filter_kelas order by guru.nama_guru asc");
				...
				while($row=mysqli_fetch_array($view)){
					...
					<tr>
						...
						if($row['kunci']=='yes'){
							?><font color="#FF0000"><b>Yes</b></font><?php
						}else{
							?><font color="#0000FF"><b>No</b></font><?php
						}
