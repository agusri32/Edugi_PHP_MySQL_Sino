...
<tr>
    ...
    <div id="content-table-inner">
		...
		$siswa=mysqli_fetch_array(mysqli_query($link,"select siswa.nama_siswa, siswa.nis, siswa.photo, kelas.nama_kelas, kelas.id_kelas from tbl_ruangan ruangan, data_siswa siswa, setup_kelas kelas where ruangan.id_siswa=siswa.id_siswa and ruangan.id_siswa='$id_siswa' and ruangan.id_kelas=kelas.id_kelas"));
