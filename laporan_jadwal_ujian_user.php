<?php
if($domain!=='mahasiswa' && $domain!=='dosen'){
...
<tr>
    ...
    <div id="content-table-inner">
			...
			$nama_mahasiswa=$_SESSION['nama_account'];
			$nis=$_SESSION['nis'];
        ...
        <tr>
          ...
          <td><input type="text" class="inp-form" name="nama_mahasiswa" value="<?php echo $nama_mahasiswa;?>" disabled="disabled"/></td>
          <td></td>
        </tr>
         <tr>
          <th valign="top">NIS</th>
          <td><input type="text" class="inp-form" name="nama_mahasiswa" value="<?php echo $nis;?>" disabled="disabled"/></td>
          <td></td>
        </tr>
        <tr>
		...
		if(isset($_POST['submit'])){
			$id_matakuliah=htmlentities($_POST['id_matakuliah']);
			...
			if($id_matakuliah!=="0"){
				$filter_matakuliah="and jadwal.id_matakuliah='$id_matakuliah'";
			}else{
				$filter_matakuliah="";
			}
		...
		$result=mysqli_query($link,"select * from tbl_jadwal_ujian jadwal, setup_kelas kelas, setup_ruang_kelas ruang, setup_matakuliah matakuliah where jadwal.id_kelas=kelas.id_kelas and jadwal.id_ruang_kelas=ruang.id_ruang_kelas and jadwal.id_matakuliah=matakuliah.id_matakuliah and jadwal.id_kelas='$id_kelas' order by id_ujian asc"); //output
		?>
		<form id="mainform" action="">
        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
        <tr>
            <th class="table-header-repeat line-left minwidth-1"><a href="">Nomor</a></th>
            <th class="table-header-repeat line-left minwidth-1"><a href="">Mata matakuliah</a></th>
